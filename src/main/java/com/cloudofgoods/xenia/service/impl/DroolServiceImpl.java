...
public class DroolServiceImpl extends RuleImpl implements DroolService {
    ...
    public void feedKnowledgeBuilderWhenUpdate(RuleRequestRootEntity allRuleSet, RuleRequestRootEntity rootRuleById) {
        log.info ("LOG:: DroolServiceImpl loadKnowledgeBuilder() Get All Rules From Database");
        for (RuleChannelObject channelsEntity : allRuleSet.getChannels ()) {
